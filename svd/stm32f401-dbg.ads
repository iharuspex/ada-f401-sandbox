...
package STM32F401.DBG is
   ...
   subtype DBGMCU_IDCODE_DEV_ID_Field is STM32F401.UInt12;
   subtype DBGMCU_IDCODE_REV_ID_Field is STM32F401.UInt16;
   ...
   subtype DBGMCU_CR_DBG_SLEEP_Field is STM32F401.Bit;
   subtype DBGMCU_CR_DBG_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_CR_DBG_STANDBY_Field is STM32F401.Bit;
   subtype DBGMCU_CR_TRACE_IOEN_Field is STM32F401.Bit;
   subtype DBGMCU_CR_TRACE_MODE_Field is STM32F401.UInt2;
   ...
   type DBGMCU_CR_Register is record
      ...
      --  unspecified
      Reserved_3_4  : STM32F401.UInt2 := 16#0#;
      --  TRACE_IOEN
   ...
   subtype DBGMCU_APB1_FZ_DBG_TIM2_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM3_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM4_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM5_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_RTC_Stop_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_WWDG_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_IWDEG_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT_Field is STM32F401.Bit;
   subtype DBGMCU_APB1_FZ_DBG_I2C3SMBUS_TIMEOUT_Field is STM32F401.Bit;
   ...
   type DBGMCU_APB1_FZ_Register is record
      ...
      --  unspecified
      Reserved_4_9           : STM32F401.UInt6 := 16#0#;
   ...
   subtype DBGMCU_APB2_FZ_DBG_TIM1_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB2_FZ_DBG_TIM9_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB2_FZ_DBG_TIM10_STOP_Field is STM32F401.Bit;
   subtype DBGMCU_APB2_FZ_DBG_TIM11_STOP_Field is STM32F401.Bit;
   ...
   type DBGMCU_APB2_FZ_Register is record
      ...
      --  unspecified
      Reserved_1_15  : STM32F401.UInt15 := 16#0#;
