...
package STM32F401.WWDG is
   ...
   subtype CR_T_Field is STM32F401.UInt7;
   subtype CR_WDGA_Field is STM32F401.Bit;
   ...
   subtype CFR_W_Field is STM32F401.UInt7;
   --  CFR_WDGTB array element
   subtype CFR_WDGTB_Element is STM32F401.Bit;
   ...
   subtype CFR_EWI_Field is STM32F401.Bit;
   ...
   subtype SR_EWIF_Field is STM32F401.Bit;
   ...
   type SR_Register is record
      ...
      --  unspecified
      Reserved_1_31 : STM32F401.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
