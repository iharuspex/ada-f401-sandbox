...
package STM32F401.GPIO is
   ...
   --  MODER array element
   subtype MODER_Element is STM32F401.UInt2;
   ...
   subtype OTYPER_OT_Element is STM32F401.Bit;
   ...
   subtype OSPEEDR_Element is STM32F401.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is STM32F401.UInt2;
   ...
   --  IDR array element
   subtype IDR_Element is STM32F401.Bit;
   ...
   --  ODR array element
   subtype ODR_Element is STM32F401.Bit;
   ...
   subtype BSRR_BS_Element is STM32F401.Bit;
   ...
   subtype BSRR_BR_Element is STM32F401.Bit;
   ...
   subtype LCKR_LCK_Element is STM32F401.Bit;
   ...
   subtype LCKR_LCKK_Field is STM32F401.Bit;
   ...
   --  AFRL array element
   subtype AFRL_Element is STM32F401.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is STM32F401.UInt4;
