...
package STM32F401.SDIO is
   ...
   subtype POWER_PWRCTRL_Field is STM32F401.UInt2;
   ...
   subtype CLKCR_CLKDIV_Field is STM32F401.Byte;
   subtype CLKCR_CLKEN_Field is STM32F401.Bit;
   subtype CLKCR_PWRSAV_Field is STM32F401.Bit;
   subtype CLKCR_BYPASS_Field is STM32F401.Bit;
   subtype CLKCR_WIDBUS_Field is STM32F401.UInt2;
   subtype CLKCR_NEGEDGE_Field is STM32F401.Bit;
   subtype CLKCR_HWFC_EN_Field is STM32F401.Bit;
   ...
   subtype CMD_CMDINDEX_Field is STM32F401.UInt6;
   subtype CMD_WAITRESP_Field is STM32F401.UInt2;
   subtype CMD_WAITINT_Field is STM32F401.Bit;
   subtype CMD_WAITPEND_Field is STM32F401.Bit;
   subtype CMD_CPSMEN_Field is STM32F401.Bit;
   subtype CMD_SDIOSuspend_Field is STM32F401.Bit;
   subtype CMD_ENCMDcompl_Field is STM32F401.Bit;
   subtype CMD_nIEN_Field is STM32F401.Bit;
   subtype CMD_CE_ATACMD_Field is STM32F401.Bit;
   ...
   subtype RESPCMD_RESPCMD_Field is STM32F401.UInt6;
   ...
   type RESPCMD_Register is record
      ...
      --  unspecified
      Reserved_6_31 : STM32F401.UInt26;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DLEN_DATALENGTH_Field is STM32F401.UInt25;
   ...
   type DLEN_Register is record
      ...
      --  unspecified
      Reserved_25_31 : STM32F401.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DCTRL_DTEN_Field is STM32F401.Bit;
   subtype DCTRL_DTDIR_Field is STM32F401.Bit;
   subtype DCTRL_DTMODE_Field is STM32F401.Bit;
   subtype DCTRL_DMAEN_Field is STM32F401.Bit;
   subtype DCTRL_DBLOCKSIZE_Field is STM32F401.UInt4;
   subtype DCTRL_RWSTART_Field is STM32F401.Bit;
   subtype DCTRL_RWSTOP_Field is STM32F401.Bit;
   subtype DCTRL_RWMOD_Field is STM32F401.Bit;
   subtype DCTRL_SDIOEN_Field is STM32F401.Bit;
   ...
   subtype DCOUNT_DATACOUNT_Field is STM32F401.UInt25;
   ...
   subtype STA_CCRCFAIL_Field is STM32F401.Bit;
   subtype STA_DCRCFAIL_Field is STM32F401.Bit;
   subtype STA_CTIMEOUT_Field is STM32F401.Bit;
   subtype STA_DTIMEOUT_Field is STM32F401.Bit;
   subtype STA_TXUNDERR_Field is STM32F401.Bit;
   subtype STA_RXOVERR_Field is STM32F401.Bit;
   subtype STA_CMDREND_Field is STM32F401.Bit;
   subtype STA_CMDSENT_Field is STM32F401.Bit;
   subtype STA_DATAEND_Field is STM32F401.Bit;
   subtype STA_STBITERR_Field is STM32F401.Bit;
   subtype STA_DBCKEND_Field is STM32F401.Bit;
   subtype STA_CMDACT_Field is STM32F401.Bit;
   subtype STA_TXACT_Field is STM32F401.Bit;
   subtype STA_RXACT_Field is STM32F401.Bit;
   subtype STA_TXFIFOHE_Field is STM32F401.Bit;
   subtype STA_RXFIFOHF_Field is STM32F401.Bit;
   subtype STA_TXFIFOF_Field is STM32F401.Bit;
   subtype STA_RXFIFOF_Field is STM32F401.Bit;
   subtype STA_TXFIFOE_Field is STM32F401.Bit;
   subtype STA_RXFIFOE_Field is STM32F401.Bit;
   subtype STA_TXDAVL_Field is STM32F401.Bit;
   subtype STA_RXDAVL_Field is STM32F401.Bit;
   subtype STA_SDIOIT_Field is STM32F401.Bit;
   subtype STA_CEATAEND_Field is STM32F401.Bit;
   ...
   subtype ICR_CCRCFAILC_Field is STM32F401.Bit;
   subtype ICR_DCRCFAILC_Field is STM32F401.Bit;
   subtype ICR_CTIMEOUTC_Field is STM32F401.Bit;
   subtype ICR_DTIMEOUTC_Field is STM32F401.Bit;
   subtype ICR_TXUNDERRC_Field is STM32F401.Bit;
   subtype ICR_RXOVERRC_Field is STM32F401.Bit;
   subtype ICR_CMDRENDC_Field is STM32F401.Bit;
   subtype ICR_CMDSENTC_Field is STM32F401.Bit;
   subtype ICR_DATAENDC_Field is STM32F401.Bit;
   subtype ICR_STBITERRC_Field is STM32F401.Bit;
   subtype ICR_DBCKENDC_Field is STM32F401.Bit;
   subtype ICR_SDIOITC_Field is STM32F401.Bit;
   subtype ICR_CEATAENDC_Field is STM32F401.Bit;
   ...
   type ICR_Register is record
      ...
      --  unspecified
      Reserved_11_21 : STM32F401.UInt11 := 16#0#;
   ...
   subtype MASK_CCRCFAILIE_Field is STM32F401.Bit;
   subtype MASK_DCRCFAILIE_Field is STM32F401.Bit;
   subtype MASK_CTIMEOUTIE_Field is STM32F401.Bit;
   subtype MASK_DTIMEOUTIE_Field is STM32F401.Bit;
   subtype MASK_TXUNDERRIE_Field is STM32F401.Bit;
   subtype MASK_RXOVERRIE_Field is STM32F401.Bit;
   subtype MASK_CMDRENDIE_Field is STM32F401.Bit;
   subtype MASK_CMDSENTIE_Field is STM32F401.Bit;
   subtype MASK_DATAENDIE_Field is STM32F401.Bit;
   subtype MASK_STBITERRIE_Field is STM32F401.Bit;
   subtype MASK_DBCKENDIE_Field is STM32F401.Bit;
   subtype MASK_CMDACTIE_Field is STM32F401.Bit;
   subtype MASK_TXACTIE_Field is STM32F401.Bit;
   subtype MASK_RXACTIE_Field is STM32F401.Bit;
   subtype MASK_TXFIFOHEIE_Field is STM32F401.Bit;
   subtype MASK_RXFIFOHFIE_Field is STM32F401.Bit;
   subtype MASK_TXFIFOFIE_Field is STM32F401.Bit;
   subtype MASK_RXFIFOFIE_Field is STM32F401.Bit;
   subtype MASK_TXFIFOEIE_Field is STM32F401.Bit;
   subtype MASK_RXFIFOEIE_Field is STM32F401.Bit;
   subtype MASK_TXDAVLIE_Field is STM32F401.Bit;
   subtype MASK_RXDAVLIE_Field is STM32F401.Bit;
   subtype MASK_SDIOITIE_Field is STM32F401.Bit;
   subtype MASK_CEATAENDIE_Field is STM32F401.Bit;
   ...
   subtype FIFOCNT_FIFOCOUNT_Field is STM32F401.UInt24;
   ...
   type SDIO_Peripheral is record
      ...
      --  argument register
      ARG     : aliased STM32F401.UInt32;
      --  command register
      CMD     : aliased CMD_Register;
      --  command response register
      RESPCMD : aliased RESPCMD_Register;
      --  response 1..4 register
      RESP1   : aliased STM32F401.UInt32;
      --  response 1..4 register
      RESP2   : aliased STM32F401.UInt32;
      --  response 1..4 register
      RESP3   : aliased STM32F401.UInt32;
      --  response 1..4 register
      RESP4   : aliased STM32F401.UInt32;
      --  data timer register
      DTIMER  : aliased STM32F401.UInt32;
      --  data length register
