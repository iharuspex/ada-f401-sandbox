...
package STM32F401.SCB is
   ...
   subtype CPUID_Revision_Field is STM32F401.UInt4;
   subtype CPUID_PartNo_Field is STM32F401.UInt12;
   subtype CPUID_Constant_Field is STM32F401.UInt4;
   subtype CPUID_Variant_Field is STM32F401.UInt4;
   subtype CPUID_Implementer_Field is STM32F401.Byte;
   ...
   subtype ICSR_VECTACTIVE_Field is STM32F401.UInt9;
   subtype ICSR_RETTOBASE_Field is STM32F401.Bit;
   subtype ICSR_VECTPENDING_Field is STM32F401.UInt7;
   subtype ICSR_ISRPENDING_Field is STM32F401.Bit;
   subtype ICSR_PENDSTCLR_Field is STM32F401.Bit;
   subtype ICSR_PENDSTSET_Field is STM32F401.Bit;
   subtype ICSR_PENDSVCLR_Field is STM32F401.Bit;
   subtype ICSR_PENDSVSET_Field is STM32F401.Bit;
   subtype ICSR_NMIPENDSET_Field is STM32F401.Bit;
   ...
   type ICSR_Register is record
      ...
      --  unspecified
      Reserved_19_21 : STM32F401.UInt3 := 16#0#;
      --  Interrupt pending flag
      ISRPENDING     : ICSR_ISRPENDING_Field := 16#0#;
      --  unspecified
      Reserved_23_24 : STM32F401.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_29_30 : STM32F401.UInt2 := 16#0#;
      --  NMI set-pending bit.
   ...
   subtype VTOR_TBLOFF_Field is STM32F401.UInt21;

   --  Vector table offset register
   type VTOR_Register is record
      --  unspecified
      Reserved_0_8   : STM32F401.UInt9 := 16#0#;
      --  Vector table base offset field
      TBLOFF         : VTOR_TBLOFF_Field := 16#0#;
      --  unspecified
      Reserved_30_31 : STM32F401.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype AIRCR_VECTRESET_Field is STM32F401.Bit;
   subtype AIRCR_VECTCLRACTIVE_Field is STM32F401.Bit;
   subtype AIRCR_SYSRESETREQ_Field is STM32F401.Bit;
   subtype AIRCR_PRIGROUP_Field is STM32F401.UInt3;
   subtype AIRCR_ENDIANESS_Field is STM32F401.Bit;
   subtype AIRCR_VECTKEYSTAT_Field is STM32F401.UInt16;
   ...
   subtype SCR_SLEEPONEXIT_Field is STM32F401.Bit;
   subtype SCR_SLEEPDEEP_Field is STM32F401.Bit;
   subtype SCR_SEVEONPEND_Field is STM32F401.Bit;
   ...
   subtype CCR_NONBASETHRDENA_Field is STM32F401.Bit;
   subtype CCR_USERSETMPEND_Field is STM32F401.Bit;
   subtype CCR_UNALIGN_TRP_Field is STM32F401.Bit;
   subtype CCR_DIV_0_TRP_Field is STM32F401.Bit;
   subtype CCR_BFHFNMIGN_Field is STM32F401.Bit;
   subtype CCR_STKALIGN_Field is STM32F401.Bit;
   ...
   subtype SHPR1_PRI_4_Field is STM32F401.Byte;
   subtype SHPR1_PRI_5_Field is STM32F401.Byte;
   subtype SHPR1_PRI_6_Field is STM32F401.Byte;
   ...
   subtype SHPR2_PRI_11_Field is STM32F401.Byte;

   --  System handler priority registers
   type SHPR2_Register is record
      --  unspecified
      Reserved_0_23 : STM32F401.UInt24 := 16#0#;
   ...
   subtype SHPR3_PRI_14_Field is STM32F401.Byte;
   subtype SHPR3_PRI_15_Field is STM32F401.Byte;
   ...
   subtype SHCRS_MEMFAULTACT_Field is STM32F401.Bit;
   subtype SHCRS_BUSFAULTACT_Field is STM32F401.Bit;
   subtype SHCRS_USGFAULTACT_Field is STM32F401.Bit;
   subtype SHCRS_SVCALLACT_Field is STM32F401.Bit;
   subtype SHCRS_MONITORACT_Field is STM32F401.Bit;
   subtype SHCRS_PENDSVACT_Field is STM32F401.Bit;
   subtype SHCRS_SYSTICKACT_Field is STM32F401.Bit;
   subtype SHCRS_USGFAULTPENDED_Field is STM32F401.Bit;
   subtype SHCRS_MEMFAULTPENDED_Field is STM32F401.Bit;
   subtype SHCRS_BUSFAULTPENDED_Field is STM32F401.Bit;
   subtype SHCRS_SVCALLPENDED_Field is STM32F401.Bit;
   subtype SHCRS_MEMFAULTENA_Field is STM32F401.Bit;
   subtype SHCRS_BUSFAULTENA_Field is STM32F401.Bit;
   subtype SHCRS_USGFAULTENA_Field is STM32F401.Bit;
   ...
   subtype CFSR_UFSR_BFSR_MMFSR_IACCVIOL_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MUNSTKERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MSTKERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MLSPERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MMARVALID_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IBUSERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_PRECISERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IMPRECISERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNSTKERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_STKERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_LSPERR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_BFARVALID_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNDEFINSTR_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVSTATE_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVPC_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_NOCP_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNALIGNED_Field is STM32F401.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_DIVBYZERO_Field is STM32F401.Bit;
   ...
   type CFSR_UFSR_BFSR_MMFSR_Register is record
      ...
      --  unspecified
      Reserved_26_31 : STM32F401.UInt6 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype HFSR_VECTTBL_Field is STM32F401.Bit;
   subtype HFSR_FORCED_Field is STM32F401.Bit;
   subtype HFSR_DEBUG_VT_Field is STM32F401.Bit;
   ...
   type HFSR_Register is record
      ...
      --  unspecified
      Reserved_2_29 : STM32F401.UInt28 := 16#0#;
      --  Forced hard fault
   ...
   subtype ACTRL_DISMCYCINT_Field is STM32F401.Bit;
   subtype ACTRL_DISDEFWBUF_Field is STM32F401.Bit;
   subtype ACTRL_DISFOLD_Field is STM32F401.Bit;
   subtype ACTRL_DISFPCA_Field is STM32F401.Bit;
   subtype ACTRL_DISOOFP_Field is STM32F401.Bit;
   ...
   type SCB_Peripheral is record
      ...
      MMFAR                : aliased STM32F401.UInt32;
      --  Bus fault address register
      BFAR                 : aliased STM32F401.UInt32;
      --  Auxiliary fault status register
      AFSR                 : aliased STM32F401.UInt32;
   end record
     with Volatile;
