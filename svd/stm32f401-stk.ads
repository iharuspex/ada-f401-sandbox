...
package STM32F401.STK is
   ...
   subtype CTRL_ENABLE_Field is STM32F401.Bit;
   subtype CTRL_TICKINT_Field is STM32F401.Bit;
   subtype CTRL_CLKSOURCE_Field is STM32F401.Bit;
   subtype CTRL_COUNTFLAG_Field is STM32F401.Bit;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_3_15  : STM32F401.UInt13 := 16#0#;
      --  COUNTFLAG
   ...
   subtype LOAD_RELOAD_Field is STM32F401.UInt24;
   ...
   subtype VAL_CURRENT_Field is STM32F401.UInt24;
   ...
   subtype CALIB_TENMS_Field is STM32F401.UInt24;
   subtype CALIB_SKEW_Field is STM32F401.Bit;
   subtype CALIB_NOREF_Field is STM32F401.Bit;
   ...
   type CALIB_Register is record
      ...
      --  unspecified
      Reserved_24_29 : STM32F401.UInt6 := 16#0#;
