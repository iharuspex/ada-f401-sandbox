...
package STM32F401.I2C is
   ...
   subtype CR1_PE_Field is STM32F401.Bit;
   subtype CR1_SMBUS_Field is STM32F401.Bit;
   subtype CR1_SMBTYPE_Field is STM32F401.Bit;
   subtype CR1_ENARP_Field is STM32F401.Bit;
   subtype CR1_ENPEC_Field is STM32F401.Bit;
   subtype CR1_ENGC_Field is STM32F401.Bit;
   subtype CR1_NOSTRETCH_Field is STM32F401.Bit;
   subtype CR1_START_Field is STM32F401.Bit;
   subtype CR1_STOP_Field is STM32F401.Bit;
   subtype CR1_ACK_Field is STM32F401.Bit;
   subtype CR1_POS_Field is STM32F401.Bit;
   subtype CR1_PEC_Field is STM32F401.Bit;
   subtype CR1_ALERT_Field is STM32F401.Bit;
   subtype CR1_SWRST_Field is STM32F401.Bit;
   ...
   subtype CR2_FREQ_Field is STM32F401.UInt6;
   subtype CR2_ITERREN_Field is STM32F401.Bit;
   subtype CR2_ITEVTEN_Field is STM32F401.Bit;
   subtype CR2_ITBUFEN_Field is STM32F401.Bit;
   subtype CR2_DMAEN_Field is STM32F401.Bit;
   subtype CR2_LAST_Field is STM32F401.Bit;
   ...
   subtype OAR1_ADD0_Field is STM32F401.Bit;
   subtype OAR1_ADD7_Field is STM32F401.UInt7;
   subtype OAR1_ADD10_Field is STM32F401.UInt2;
   subtype OAR1_ADDMODE_Field is STM32F401.Bit;
   ...
   subtype OAR2_ENDUAL_Field is STM32F401.Bit;
   subtype OAR2_ADD2_Field is STM32F401.UInt7;
   ...
   subtype DR_DR_Field is STM32F401.Byte;
   ...
   subtype SR1_SB_Field is STM32F401.Bit;
   subtype SR1_ADDR_Field is STM32F401.Bit;
   subtype SR1_BTF_Field is STM32F401.Bit;
   subtype SR1_ADD10_Field is STM32F401.Bit;
   subtype SR1_STOPF_Field is STM32F401.Bit;
   subtype SR1_RxNE_Field is STM32F401.Bit;
   subtype SR1_TxE_Field is STM32F401.Bit;
   subtype SR1_BERR_Field is STM32F401.Bit;
   subtype SR1_ARLO_Field is STM32F401.Bit;
   subtype SR1_AF_Field is STM32F401.Bit;
   subtype SR1_OVR_Field is STM32F401.Bit;
   subtype SR1_PECERR_Field is STM32F401.Bit;
   subtype SR1_TIMEOUT_Field is STM32F401.Bit;
   subtype SR1_SMBALERT_Field is STM32F401.Bit;
   ...
   subtype SR2_MSL_Field is STM32F401.Bit;
   subtype SR2_BUSY_Field is STM32F401.Bit;
   subtype SR2_TRA_Field is STM32F401.Bit;
   subtype SR2_GENCALL_Field is STM32F401.Bit;
   subtype SR2_SMBDEFAULT_Field is STM32F401.Bit;
   subtype SR2_SMBHOST_Field is STM32F401.Bit;
   subtype SR2_DUALF_Field is STM32F401.Bit;
   subtype SR2_PEC_Field is STM32F401.Byte;
   ...
   subtype CCR_CCR_Field is STM32F401.UInt12;
   subtype CCR_DUTY_Field is STM32F401.Bit;
   subtype CCR_F_S_Field is STM32F401.Bit;
   ...
   subtype TRISE_TRISE_Field is STM32F401.UInt6;
