...
package STM32F401.MPU is
   ...
   subtype MPU_TYPER_SEPARATE_Field is STM32F401.Bit;
   subtype MPU_TYPER_DREGION_Field is STM32F401.Byte;
   subtype MPU_TYPER_IREGION_Field is STM32F401.Byte;
   ...
   subtype MPU_CTRL_ENABLE_Field is STM32F401.Bit;
   subtype MPU_CTRL_HFNMIENA_Field is STM32F401.Bit;
   subtype MPU_CTRL_PRIVDEFENA_Field is STM32F401.Bit;
   ...
   type MPU_CTRL_Register is record
      ...
      --  unspecified
      Reserved_3_31 : STM32F401.UInt29;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MPU_RNR_REGION_Field is STM32F401.Byte;
   ...
   subtype MPU_RBAR_REGION_Field is STM32F401.UInt4;
   subtype MPU_RBAR_VALID_Field is STM32F401.Bit;
   subtype MPU_RBAR_ADDR_Field is STM32F401.UInt27;
   ...
   subtype MPU_RASR_ENABLE_Field is STM32F401.Bit;
   subtype MPU_RASR_SIZE_Field is STM32F401.UInt5;
   subtype MPU_RASR_SRD_Field is STM32F401.Byte;
   subtype MPU_RASR_B_Field is STM32F401.Bit;
   subtype MPU_RASR_C_Field is STM32F401.Bit;
   subtype MPU_RASR_S_Field is STM32F401.Bit;
   subtype MPU_RASR_TEX_Field is STM32F401.UInt3;
   subtype MPU_RASR_AP_Field is STM32F401.UInt3;
   subtype MPU_RASR_XN_Field is STM32F401.Bit;
