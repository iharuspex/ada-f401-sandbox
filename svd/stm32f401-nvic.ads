...
package STM32F401.NVIC is
   ...
   subtype IPR_IPR_N_Element is STM32F401.Byte;
   ...
   subtype STIR_INTID_Field is STM32F401.UInt9;
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : aliased STM32F401.UInt32;
      --  Interrupt Set-Enable Register
      ISER1 : aliased STM32F401.UInt32;
      --  Interrupt Set-Enable Register
      ISER2 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Enable Register
      ICER2 : aliased STM32F401.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased STM32F401.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased STM32F401.UInt32;
      --  Interrupt Set-Pending Register
      ISPR2 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased STM32F401.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR2 : aliased STM32F401.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : aliased STM32F401.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : aliased STM32F401.UInt32;
      --  Interrupt Active Bit Register
      IABR2 : aliased STM32F401.UInt32;
      --  Interrupt Priority Register
